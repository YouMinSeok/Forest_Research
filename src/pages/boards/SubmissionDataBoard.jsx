...
function SubmissionDataBoard() {
  ...
  // 게시글 클릭 시, 상세 페이지로 이동 (예: /research/submission-data/:postId)
  const handlePostClick = (post) => {
    navigate(`/research/submission-data/${post.id}`, { state: { post } });
  };
  ...
  return (
    <div className="board-page">
      ...
      {showWrite && (
        <CafeWritePost boardList={['제출자료']} onSubmit={handleWriteSubmit} />
      )}
    </div>
  );
}
